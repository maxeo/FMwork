        <section id="worksdone" class="main special">
            ...
            <p class="justify" id="proj_mycloud">
                ...
                A small file manager written in php, I created it some time ago, is very powerful, but, becasuse I was the only one user, I neglected the security aspect ...<br>
                The demo vesion is only part of the program. Sooner or later I will create a 2.0 version available to everyone<br>
                <a class="to_target" href="#headerTarget">Torna su</a></p>
            <p class="justify" id="proj_braingame">
                ...
                Nice little game that I created during train travel to the university. You set the difficulty, the time, and play; there is also a Timemode version where if the answer is correct it given time extra.<br>
                <a class="to_target" href="#headerTarget">Torna su</a></p>
            <p class="justify" id="proj_produzioneoga">
                ...
                This is one of the programs that I created while I was in Typography. For various reasons I can not make available the entire platform, so I offer this version of HTML + JavaScript exported via Firefox<br>
                <a class="to_target" href="#headerTarget">Torna su</a></p>
            <p class="justify" id="proj_quantificaetichette">
                ...
                To apologize for the above, this is a "full version" of a small utility, anchessa realized while working at the printers.<br>
                <a class="to_target" href="#headerTarget">Torna su</a></p>
            ...
            <p class="justify" id="proj_qrcodemaker">
                ...
                This program allows you to create custom qrcode, both as regards the text, both as regards the design, impressing background images, stondando or blurring the pixels of the code.<br>
                <a class="to_target" href="#headerTarget">Torna su</a></p>
