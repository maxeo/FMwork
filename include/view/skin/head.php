<head>
    <title><?php $thisPgTarget = Pageloader::getData("target");echo "Matteo Burbui - "; ?>Maxeo.it<?php if (!empty($thisPgTarget) && $thisPgTarget != "home") echo " - " . ucwords(str_replace("-", " ", Pageloader::getData("page"))); ?></title>
    <meta charset="utf-8" />
