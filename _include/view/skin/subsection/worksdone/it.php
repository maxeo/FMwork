        <section id="lavorisvolti" class="main special">
            ...
            <ul class="statistics no_margin_bot">
                ...
                <li class="style5">
                    <a href="#proj_produzioneoga" class="to_target">
                        ...
                        <strong>Produzione OGA</strong> Diario di lavoro
                    </a>
                </li>
            </ul>
            <ul class="statistics">
                <li class="style6">
                    <a href="#proj_quantificaetichette" class="to_target">
                        ...
                        <strong>Quantifica Etichette</strong> Calcolatrice di utility
                    </a>
                </li>
                <li class="style7">
                    <a href="#proj_masterkanjiitaly" class="to_target">
                        <span class="icon fa-kanji"></span>
                        <strong>Master Kanji Italy</strong> Sito per imparare i kanji
                    </a>
                </li>
                <li class="style8">
                ...
                <li class="style9">
                    <a href="#proj_qrcodemaker" class="to_target">
                        ...
                        <strong>QRcode Maker</strong> Genera un qrcode <i>"grafico"</i>
                    </a>
                </li>
                <li class="style10">
            ...
            <p class="justify" id="proj_webframe">
                ...
                contiene gli elementi grafici che la compongono.<br>
